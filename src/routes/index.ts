...
import { studentEnrollCourseMarkRoutes } from '../app/modules/student_enroll_course_mark/student_enroll_course_mark_route';
...
router.use('/student-enroll-course-mark', studentEnrollCourseMarkRoutes);
